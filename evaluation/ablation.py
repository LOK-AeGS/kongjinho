...
실행: python -m evaluation.ablation --corpus data/corpus --embedding BAAI/bge-m3
"""
...
from evaluation.golden_set import GOLDEN_SET, GoldenItem, marker_hit
from rag.evidence import normalize_text
from rag.fetch import fetch_document
from rag.index import BM25Index, Chunk, DenseIndex, HybridIndex, chunk_parts
...
def run_ablation(
    ...
    if artifact_dir is not None:
        from runtime.artifacts import describe_cache, save_bm25, save_chunks, save_faiss
